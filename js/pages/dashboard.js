...
import { YEARS, SUBJECTS, SEM_LABEL, CATEGORY_META, KB, STARTER_FLASHCARDS } from '../data.js?v=5f017ca';
import { store, loadManifest, getManifest, todayISO } from '../storage.js?v=5f017ca';
