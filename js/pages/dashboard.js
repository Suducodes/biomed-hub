...
import { YEARS, SUBJECTS, SEM_LABEL, CATEGORY_META, KB, STARTER_FLASHCARDS } from '../data.js?v=960a27c';
import { store, loadManifest, getManifest, todayISO } from '../storage.js?v=960a27c';
