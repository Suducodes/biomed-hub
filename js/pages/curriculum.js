...
import { YEARS, SEM_LABEL, subjectsOf, subjectById, CATEGORY_META } from '../data.js?v=960a27c';
import { librarySubject, store, loadManifest, toggleUnitDone, isUnitDone, subjectProgress, toast } from '../storage.js?v=960a27c';
